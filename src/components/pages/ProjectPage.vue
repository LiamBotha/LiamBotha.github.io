            ...
            <v-card
                ...
                <v-row no-gutters>
                    <v-col v-for="n in project.images.length / 2">
                        <v-img :src="'/project images/'+ project.images[(n - 1) * 2]" class="ma-1" cover max-height="" eager/>
                        <v-img :src="'/project images/'+ project.images[(n) * 2 - 1]" class="ma-1" cover max-height="" eager/>
                    </v-col>
                </v-row>
            </v-card>
        </v-container>
